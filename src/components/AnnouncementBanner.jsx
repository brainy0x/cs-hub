  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
        {/* Label pill */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '8px 12px', borderRight: '1px solid #2a2a28', flexShrink: 0 }}>
        ...
        <button onClick={() => setExpanded(e => !e)} style={{
          padding: '8px 12px', borderLeft: '1px solid #2a2a28', background: 'transparent',
